...
class MotivacionPropiaActividades extends React.Component{
    render(){
        return(
            <body>
                <TituloPrincipal TituloPrincipal='Hola Anghy, hoy te motivaras a ti misma' /> 
...
export default MotivacionPropiaActividades;