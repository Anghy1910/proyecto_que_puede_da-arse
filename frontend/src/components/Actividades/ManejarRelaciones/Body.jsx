...
class ManejarRelacionesActividades extends React.Component{
    render(){
        return(
            <body>
                <TituloPrincipal TituloPrincipal='Hola Anghy, hoy aprenderas a manejar tus relaciones' /> 
...
export default ManejarRelacionesActividades;